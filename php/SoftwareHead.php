...
$sql_complaint = "SELECT comp_id, emp_name, intercom, issue, status, dept FROM complaints WHERE status='Pending' and dept='Software'";
...
<head>
  ...
  <title>Software Incharge Dashboard</title>
  ...
  <div class="page-layout">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <ul>
          <li><a href="../php/SoftwareProfile.php"><i class="fa-solid fa-user"></i> User Profile</a></li>
          <li><a href="../php/SoftwareRecords.php"><i class="fa-solid fa-screwdriver-wrench"></i> View Complaints</a>
          </li>
