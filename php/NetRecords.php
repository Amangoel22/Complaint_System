...
$sql_complaint = "SELECT comp_id, emp_name, eng_assig, intercom, issue, eng_assig, status, dept FROM complaints WHERE status='Resolved' and dept='Networking'";
...
<head>
  ...
  <title>Networking Complaints Record</title>
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <ul>
          ...
          <li><a href="../php/NetHead.php"><i class="fa-solid fa-arrow-left"></i> Back to Dashboard</a>
          </li>
        </ul>
      </nav>
    </aside>
