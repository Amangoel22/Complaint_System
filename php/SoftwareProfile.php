<?php
    ...
    user_type, role,telephone_no, user_name FROM id_emp WHERE role='Software Admin'";
...
<head>
  ...
  <title>Software Incharge Profile</title>
  <link rel="stylesheet" href="../css/index.css" />
  <link rel="stylesheet" href="../css/softwareprofile.css" />
...
<body>
  ...
  <header class="main-header">
    <div class="header-inner">
      ...
      <div class="header-center">
        <h1 class="title-main">
          अग्नि, विस्फोटक एवं पर्यावरण सुरक्षा केंद्र
        </h1>
        <p class="sub-title">
  ...
  <main class="main-content" style="background-color: transparent">
    <div class="whitebg">
      <h2>Software Incharge Profile</h2>
      <form action="signup.php" method="POST">
        <div class="row">
          ...
          <div class="password-wrapper">
            ...
            <a href="../php/SoftwareHead.php" class="btn small dashboard-button">
              Go to Dashboard
            </a>
          </div>
