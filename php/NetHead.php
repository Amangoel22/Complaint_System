...
$sql_complaint = "SELECT comp_id, emp_name, intercom, issue, status, dept FROM complaints WHERE status='Pending' and dept='Networking'";
...
<head>
  ...
  <title>Networking Incharge Dashboard</title>
  ...
  <div class="page-layout">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <ul>
          <li><a href="../php/NetProfile.php"><i class="fa-solid fa-user"></i> User Profile</a></li>
          <li><a href="../php/Netrecords.php"><i class="fa-solid fa-screwdriver-wrench"></i> Past
              Complaints</a>
          </li>
    ...
    if ($result_complaint && $result_complaint->num_rows > 0) {
        while($row = $result_complaint->fetch_assoc()) {
            ...
            echo "<td><button class='review-btn' onclick=\"openReviewModal('".$row['comp_id']."', '30-06-2025', 'Networking', '".addslashes($row['issue']) . "')\">Review</button></td>";
            echo "</tr>";
        }
    } else {
