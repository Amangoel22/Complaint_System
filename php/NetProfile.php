<?php
    ...
    user_type, role,telephone_no, user_name FROM id_emp WHERE role='Networking Admin'";
...
<head>
  ...
  <title>Networking Incharge Profile</title>
  <link rel="stylesheet" href="../css/index.css" />
  <link rel="stylesheet" href="../css/networkingprofile.css" />
...
<body>
  ...
  <main class="main-content" style="background-color: transparent">
    <div class="whitebg">
      <h2>Networking Incharge Profile</h2>
      <form action="signup.php" method="POST">
        <div class="row">
          ...
          <div class="group">
            ...
            <div class="display-field" id="role"><?php echo $role;?>n</div>
          </div>
          <div class="group">
          ...
          <div class="password-wrapper">
            ...
            <a href="../php/NetHead.php" class="btn small dashboard-button">
              Go to Dashboard
            </a>
          </div>
