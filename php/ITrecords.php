...
$sql_complaint = "SELECT comp_id, emp_name, eng_assig, intercom, issue, eng_assig, status, dept FROM complaints WHERE status='Resolved' and dept='IT'";
...
<head>
    ...
    <title>IT Complaints Record</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />
  <link rel="stylesheet" href="../css/index.css" />
  <link rel="stylesheet" href="../css/ITrecords.css" />
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <ul>
          ...
          <li><a href="../php/ITHead.php"><i class="fa-solid fa-arrow-left"></i> Back to Dashboard</a></li>
        </ul>
      </nav>
    </aside>
